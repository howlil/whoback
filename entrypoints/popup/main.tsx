    ...
    <section className="surface overflow-hidden rounded-2xl">
      ...
      {!loaded ? <div className="p-5 text-sm text-muted">Loading…</div> : !state.account ? (
        ...
        <div className="p-4">
          ...
          </> : !busy && <div className="mt-4 rounded-xl border border-dashed border-line p-4 text-center"><p className="text-sm font-medium">Ready for your first check</p><p className="mt-1 text-xs leading-5 text-muted">WhoBack reads followers and following through your existing Instagram session.</p><button className="focus-ring mt-3 rounded-lg bg-brand px-3 py-2 text-xs font-semibold text-white" onClick={startSync}>Check now</button></div>}
